...
from spotifier.api import(
    ...
    DownloaderSong, ArtistCloner, MYLikeCloner, GetAllTracks, TracksFeatures
    )
from spotifier import views

urlpatterns = [
    path('track/feature/', TracksFeatures.as_view(), name='track_feature'),
    ...
    path('corrector/id', views.spotify_id_corrector, name='json_liker'),
]
